    ...
    Color Divider)
{
    ...
    public static readonly Color ClaudeClay = Color.FromArgb(0xD9, 0x77, 0x57);
    ...
    public static Color Provider(QuotaProvider provider) =>
        provider == QuotaProvider.Codex ? CodexGreen : ClaudeClay;
